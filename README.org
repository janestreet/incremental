...
it in [[https://github.com/janestreet/incremental_kernel/blob/master/src/incremental_intf.ml][/janestreet/incremental_kernel/blob/master/src/incremental_intf.ml]].  You can also find an informal
