...
it in [[https://github.com/janestreet/incremental/blob/master/src/incremental_intf.ml][incremental/src/incremental_intf.ml]].  You can also find
informal introductions to the library in this [[https://blog.janestreet.com/introducing-incremental][blog post]] and
this [[https://www.youtube.com/watch?v=G6a5G5i4gQU][video]].
