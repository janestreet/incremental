...
(* OASIS_START *)
(* DO NOT EDIT (digest: f40efb443be6b2377c1f4093aaf9db91) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          oasis_version = "0.3";
          ocaml_version = Some (OASISVersion.VGreaterEqual "4.02.1");
          ...
          copyrights =
            [
               "(C) 2008-2015 Jane Street Group LLC <opensource@janestreet.com>"
            ];
          maintainers =
            ["Jane Street Group"; "LLC <opensource@janestreet.com>"];
          authors = ["Jane Street Group"; "LLC <opensource@janestreet.com>"];
          homepage = Some "https://github.com/janestreet/incremental";
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Compile and install the small bench program";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                     cs_name = "incremental_lib";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("pa_test.syntax", None);
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "incremental_lib";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "incremental_bench_lib";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("core", None);
                           InternalLibrary "incremental_lib"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
                   ...
                   {
                      lib_modules = ["Bench"; "Import"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "incremental_lib";
                      lib_findlib_name = Some "bench";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "incremental_bench";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("core", None);
                           InternalLibrary "incremental_bench_lib"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\026\240u\1276!.\133,\145\025\209\215\254\011\019";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
